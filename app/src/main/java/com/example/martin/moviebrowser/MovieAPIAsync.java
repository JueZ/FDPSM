...
public class MovieAPIAsync extends AsyncTask<String, Void, ArrayList<Movie>> {
    public String DEBUG_TAG = "MOVIE_SEARCH";
    private AsyncListener resultListener;
    private char getParameter;

    public MovieAPIAsync(AsyncListener listener, char getParameter) {
    ...
    public ArrayList<Movie> parseMovie(String string) throws IOException, UnsupportedEncodingException {
        ...
        try {
            ...
            if (o != null) {
                ...
                movie.setPosterBitmap(getBitmap(o.get("Poster").getAsString()));
